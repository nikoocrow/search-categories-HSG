...
function search_categories() {
 ...
 <div class="dropdown-container">
        <div class='search-boxSB'>
            <input type='text' name='categories'  id='categories-input'  placeholder='type here the service you need' autocomplete='off'>
                <div class='autocom-boxSB' id="autocom-list">
